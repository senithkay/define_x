...
const words = ["Optimized", "Efficient", "Scalable", "Modern"];

export function V0Landing() {

  return (
      <div className="flex flex-col min-h-[100dvh]">
        <Parallax pages={2.5} className={'h-fit overflow-scroll no-scrollbar'}>
          <ParallaxLayer speed={0.5}>
            <img className={'w-full'} src="/background.jpeg" alt="background"/>
          </ParallaxLayer>
            ...
            <main className="flex-1">
              <section
                ...
                <div className="max-w-md space-y-4">
                  <h1 className="text-4xl font-bold"> We provide
                    <FlipWords words={words}/>
                    Software Solutions
                  </h1>
                  <p className="text-gray-300">
                    T minus 4 provides cutting-edge software solutions to help businesses thrive in the digital age.
                  </p>
                    ...
                    <Fadeincomponent>
                      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                        ...
                        <div className="p-6">
                          ...
                          <p className="text-gray-600 mt-2">A custom e-commerce platform that increased sales by
                            30%.</p>
                        </div>
                      </div>
                    </Fadeincomponent>
              ...
              <section className="py-20 px-6 md:px-12" id="team">
                <div className="max-w-5xl mx-auto space-y-8 text-center">
                  ...
                  <p className=" text-white">Meet the talented individuals who make DefineX a success.</p>
              ...
              <section className="py-20 px-6 md:px-12" id="features">
                <div className="max-w-5xl mx-auto space-y-8 text-center">
                  ...
                  <p className="text-white">Discover the key features that make DefineX stand out.</p>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <Fadeincomponent>
                      <div className="bg-white rounded-lg shadow-lg p-6 text-left">
                    ...
                    <Fadeincomponent>
                      <div className="bg-white rounded-lg shadow-lg p-6 text-left">
                        ...
                        <p className="text-gray-600 mt-2">
                          Our software solutions are designed to scale with your business, ensuring they grow alongside
                          your
                          needs.
                        </p>
                      </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-white rounded-lg shadow-lg p-6 text-left">
                      ...
                      <p className="text-gray-600 mt-2">
                        ...
                        drive growth and innovation. We are dedicated to delivering exceptional results and building
                        long
                      </p>
                    </div>
                    <div className="bg-white rounded-lg shadow-lg p-6 text-left">
